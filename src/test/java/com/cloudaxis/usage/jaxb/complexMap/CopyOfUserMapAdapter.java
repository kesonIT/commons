...
public class CopyOfUserMapAdapter extends XmlAdapter<MapEntity, Map<String, User>> {

	@Override
	public MapEntity marshal(Map<String, User> map) throws Exception {
